...
class BezierUtil
{
	 ...
	 */
	public static inline function mix2(p:Float, a:Float, b:Float):Float
	{
		return a * (1 - p) + (b * p);
	}
	 ...
	 */
	public static inline function mix3(p:Float, a:Float, b:Float, c:Float):Float
	{
		return mix2(p, mix2(p, a, b), mix2(p, b, c));
	}

	public static inline function mix4(p:Float, a:Float, b:Float, c:Float, d:Float):Float
	{
		return mix2(p, mix3(p, a, b, c), mix3(p, b, c, d));
	}

	public static inline function mix5(p:Float, a:Float, b:Float, c:Float, d:Float, e:Float):Float
	{
