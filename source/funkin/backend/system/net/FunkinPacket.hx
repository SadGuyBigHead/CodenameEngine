...
class FunkinPacket implements haxe.Constraints.IMap<String, Dynamic>
{
	...
	public static function fromJson(json:OneOfTwo<String, haxe.DynamicAccess<Dynamic>>):FunkinPacket
	{
		return (new FunkinPacket().appendJson(json));
	}
	...
	inline public function stringify():String
	{
		return haxe.Json.stringify(toJson());
	}
	...
	inline public function get(key:String):Null<Dynamic>
	{
	...
	inline public function keyValueIterator():KeyValueIterator<String, Dynamic>
	{
		return fields.keyValueIterator();
	}
	...
	{
		return 'FunkinPacket (Status: $status)';
	}
}
