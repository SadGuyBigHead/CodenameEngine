...
class CharacterSelectionScreen extends EditorTreeMenuScreen
{
	...
	public function new()
	{
		...
		for (o in generateList(modsList, isMods))
			add(o);
	}
	...
	public function createCharacter(name:String, imageSaveData:ImageSaveData, xml:Xml)
	{
		...
		{
			parent.openSubState(new UIWarningSubstate(TU.translate('characterCreationScreen.warning.char-exists-title'),
				TU.translate('characterCreationScreen.warning.char-exists-body'), [
				{
