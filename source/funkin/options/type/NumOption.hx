...
class NumOption extends TextOption
{
	...
	{
		if (__number != null && v != currentValue)
			__number.text = TextOption.OPTION_VALUE_PREFIX + Std.string(v);
	...
	public function new(text:String, desc:String, min:Float, max:Float, step:Float = 1, ?optionName:String, ?changedCallback:Float->Void = null,
			?parent:Dynamic)
	{
